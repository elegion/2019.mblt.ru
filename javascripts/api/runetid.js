var RunetId = new function () {
    var instance;
    try {
        var baseUrl = document.currentScript.getAttribute('data-base-url') || 'https://runet-id.com';
    } catch (e) {
        var baseUrl = 'https://runet-id.com';
    }
    // Конструктор
    function RunetId() {
        if (!instance) {
            ...
            this.url = baseUrl + '/oauth/main/dialog/';
            this.recoverUrl = baseUrl + '/oauth/main/recover/';
            this.width = 620;
            this.height = 662;
